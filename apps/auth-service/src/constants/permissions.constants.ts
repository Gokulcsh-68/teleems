...
export const PERMISSION_MASTER: Permission[] = [
  ...
  {
    key: 'full_crud_all_entities',
    label: 'Full CRUD on all entities',
    category: 'Platform',
  },
  ...
  {
    key: 'manage_hospital_trips',
    label: 'Manage trips for own hospital',
    category: 'Hospital',
  },
  {
    key: 'create_modify_trips',
    label: 'Create/modify trips',
    category: 'Hospital',
  },
  { key: 'view_fleet_map', label: 'View fleet map', category: 'Hospital' },
  { key: 'send_pre_alerts', label: 'Send pre-alerts', category: 'Hospital' },
  {
    key: 'telelink_accept_initiate',
    label: 'TeleLink accept/initiate',
    category: 'Hospital',
  },
  { key: 'rtvs_view', label: 'RTVS view', category: 'Hospital' },
  { key: 'epcr_read', label: 'ePCR read', category: 'Hospital' },
  {
    key: 'clinical_notes_write',
    label: 'Clinical notes write',
    category: 'Hospital',
  },
  ...
  // Station Permissions
  {
    key: 'manage_assigned_station_vehicles',
    label: 'Vehicle management for assigned station',
    category: 'Station',
  },
  {
    key: 'manage_assigned_station_crew',
    label: 'Crew management for assigned station',
    category: 'Station',
  },

  // Trip / Patient Permissions
  {
    key: 'accept_reject_trips',
    label: 'Accept/reject own trips',
    category: 'Trip',
  },
  ...
  {
    key: 'epcr_write',
    label: 'ePCR write for active patient',
    category: 'Patient',
  },
  ...
  {
    key: 'dispatch_vehicles',
    label: 'Dispatch vehicles',
    category: 'Dispatch',
  },
  {
    key: 'view_fleet_in_zone',
    label: 'View all fleet in zone',
    category: 'Dispatch',
  },
  ...
  {
    key: 'receive_referral_notifications',
    label: 'Receive referral notifications',
    category: 'Referral',
  },
  {
    key: 'manage_onboard_care',
    label: 'Manage on-board patient care',
    category: 'Clinical',
  },
];
