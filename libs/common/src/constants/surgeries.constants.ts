export const COMMON_SURGERIES = [
  ...
  { name: 'Cholecystectomy (Gallbladder Removal)', category: 'General Surgery', isCommon: true },
  ...
  // Cardiovascular
  { name: 'Coronary Artery Bypass Graft (CABG)', category: 'Cardiovascular', isCommon: true },
  { name: 'Angioplasty / Stenting', category: 'Cardiovascular', isCommon: true },
  ...
  { name: 'Nephrectomy (Kidney Removal)', category: 'Urology', isCommon: false },
