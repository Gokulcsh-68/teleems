export const COMMON_ALLERGENS = [
  ...
  { name: 'Pet Dander (Cats, Dogs)', category: 'Environmental', isCommon: true },
  { name: 'Pollen (Ragweed, Grass)', category: 'Environmental', isCommon: true },
  { name: 'Contrast Dye (X-ray/CT)', category: 'Environmental', isCommon: false }
];
