export const COMMON_ICD10_CODES = [
  ...
  {
    code: 'I63.9',
    description: 'Cerebral infarction, unspecified (Stroke)',
  ...
  {
    code: 'S06.9X0A',
    description: 'Unspecified intracranial injury, initial encounter',
    category: 'Trauma',
    isCommon: true,
  },
  {
    code: 'S36.90XA',
    description: 'Unspecified injury of unspecified intra-abdominal organ',
    category: 'Trauma',
    isCommon: true,
  },
  {
